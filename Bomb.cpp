...
BEGIN_MESSAGE_MAP(CBombApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBombApp::OnAppAbout)
END_MESSAGE_MAP()


// CBombApp construction

CBombApp::CBombApp() noexcept
{
	...
	SetAppID(_T("Bomb.AppID.NoVersion"));
